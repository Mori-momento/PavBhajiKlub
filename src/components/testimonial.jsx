...
const TestimonialSection = () => {
  ...
  return (
    <div className="bg-black h-[100vh] relative flex items-center py-10 sml:h-[100%]">
      <div className="w-[80%] mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-5xl sml:text-4xl absolute top-20 left-16 sml:static font-extrabold text-[#f97316] mb-8">Testimonials</h2>
