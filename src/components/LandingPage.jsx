...
export default function LandingPage() {
  ...
  return (
    <div className="sml:h-[175vh]  h-screen bg-black">
      <nav className="fixed top-0 z-50 w-full px-6 py-4 flex items-center justify-between bg-black ">
        <div className="flex items-center shrink-0 mr-6">
          <span className="font-bold text-[#f97316] text-[30px] ">PBK</span>
        </div>
      ...
      <div className="flex flex-wrap h-[100px] w-full grid grid-cols-2 gap-2 p-10 my-10 text-black sml:grid-cols-1">
        ...
        <div className="h-full w-full shrink items-center  row-span-3 rounded-lg sml:order-2 sml:h-[65vh]">
          <Carousel items={carouselItems} />
        </div>
        <div className="h-[250px] w-full flex shrink sml:order-4 sml:h-[20vh] sml:mt-0 sml:relative sml:top-[0%]">
        ...
        <div className="h-[70px] w-full shrink sml:order-3 sml:h-[40px] sml:mb-1 sml:relative sml:top-[0%]">
          <button
            onClick={openPdf}
